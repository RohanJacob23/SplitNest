				...
				<SheetPortal forceMount>
					...
					>
						...
						>
							<div
								className={cn(
									"relative flex h-full flex-col gap-4 rounded-lg border bg-background pr-3 shadow-xl",
									className,
								)}
							>
								{children}
								...
								<div
									...
									className="-translate-y-1/2 absolute top-1/2 right-0 mr-1 h-24 w-2 rounded-full bg-accent hover:cursor-grab"
								/>
							</div>
						</motion.div>
					</SheetPrimitive.Content>
